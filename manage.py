...
def make_app():
    ...
    print("mysql-url: ", f"""mysql+mysqlconnector://dbmasteruser:EDl=uo(*k^(0wzc+>aor[J*R`&yS_smS@ls-ecdee0357dd59b21c7ea5b0c99864d4255ce680b.co3jgj7mhva9.eu-west-3.rds.amazonaws.com:3306/bluebiz""")
